...
class Site extends CI_Model
{
	...
	*********/
    ...
    public function syncPurchaseItems__($data = array()) 
	{
        if (!empty($data)) {
            foreach ($data as $items) {
                foreach ($items as $item) { 
	...
	public function syncPurchaseItems_delivery_old1($data = array(), $delivery_id = NULL,$tran_date)
	{
	...
	public function syncPurchaseItems_delivery_old($data = array(), $delivery_id = NULL)
	{
		if (!empty($data)) {
            foreach ($data as $items) {
                foreach ($items as $item) {
