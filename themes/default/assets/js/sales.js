...
function loadItems() {
	if (localStorage.getItem('slitems')) {
		...
		var tfoot = '<tr id="tfoot" class="tfoot active"><th colspan="'+col+'">Total</th><th class="text-center">' + parseFloat(count - 1) + '</th><th></th>';
		if (site.settings.product_discount == 1) {
