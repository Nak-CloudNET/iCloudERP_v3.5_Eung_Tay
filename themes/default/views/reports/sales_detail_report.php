                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed table-striped">
						...
						<?php 
							...
							?>
								...
								<tr class="info-reference_no">
                                    ...
                                    <td colspan="13" style="font-size:18px;" class="left">
								...
								?>
										<tr>			
											<td></td>
                                            <td>
                                                <img src="<?php echo base_url('assets/uploads/' . $sale_detail->image) ?>"
								...
								<tr style="font-weight:bold;">
									<td></td>
                                    <td colspan="9" class="info-reference_no right"></td>
								...
								<tr style="font-weight:bold;">
									<td></td>
                                    <td colspan="10" class="info-reference_no right"><?= lang("order_discount") ?>:
                                    </td>
									<td></td>
								...
								<tr style="font-weight:bold;">
									<td></td>
                                    <td colspan="10" class="info-reference_no right"><?= lang("shipping") ?> :</td>
									<td></td>
								...
								<tr style="font-weight:bold;">
									<td></td>
                                    <td colspan="10" class="info-reference_no right"><?= lang("subtotal") ?> :</td>
									<td class="right"></td>
								...
								<tr style="font-weight:bold; display:none;">
									<td></td>
                                    <td colspan="10" class="info-reference_no right"><?= lang("total_amount") ?> :</td>
									<td></td>
                        ...
                        <tfoot>
							...
							<tr>
                                <th colspan="11" style="color:#0586ff" class="right info-foot"><?= lang("total") ?>:
                                </th>
							...
							<tr>
                                <th colspan="11" class="right info-foot"
							...
							<tr>
                                <th colspan="11" style="color:#0586ff"
