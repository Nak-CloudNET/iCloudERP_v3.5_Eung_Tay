...
<body>
	...
	<?php
		$cnote_id = explode(',', $inv->cnote_id);
		$this->db
		    ->select("erp_categories_note.id as id, erp_categories_note.description as cnote")
			->from("erp_categories_note")->where_in("id", $cnote_id);
			$q = $this->db->get();
