...
<div class="container" style="width: 821px;margin: 0 auto;">
    <div class="col-sm-12 col-xs-12">
        <?php if (isset($biller->logo)) { ?>
            <div class="col-xs-3 text-center" style="margin-bottom:20px;margin-top:-25px;margin-left:-35px;">
                <img style="height:80px !important;width:100px !important" src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>"
                    alt="<?= $biller->company != '-' ? $biller->company : $biller->name; ?>">
            </div>
        <?php }else{ ?>
            <div class="col-xs-3 text-center" style="margin-bottom:20px; padding-top:30px;"></div>
        <?php } ?>
        <div class="col-xs-6 text-center" style="padding-left:90px !important;">
            ...
            <div class="col-sm-12 col-xs-12">
                <table class="table table-bordered" style="margin-top: 5px;">
                            ...
                            <td style="vertical-align: middle; text-align: center">
                                <?php
									if ($row->piece == 0) {
										...
										echo $this->erp->formatQuantity($row->piece);
									}
                                ?>
                            </td>
                            <td style="vertical-align: middle; text-align: center">
							 ...
							 <td style="vertical-align: middle; text-align: center">
                                <?php
									if ($row->piece == 0) {
										...
										echo $this->erp->formatQuantity($row->piece * $row->wpiece);
									}
                                ?>
                            </td>
					...
					<?php if($invs->order_discount > 0) { ?>
						<tr>
							<td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;">បញ្ចុះតម្លៃ / <?= strtoupper(lang('order_discount :')) ?>
							</td>
