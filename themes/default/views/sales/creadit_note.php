		...
		<div class="row">
			<div class="col-lg-3 col-sm-3 col-xs-3">
				<?php if(!empty($biller->logo)) { ?>
					<img src="<?= base_url() ?>assets/uploads/logos/<?= $biller->logo; ?>" style="width: 150px; margin-left: 25px !important;" />
				<?php } ?>
			</div>
			<div class="col-lg-6 col-sm-6 col-xs-6">
				<center><h2 style="font-weight:bold !important;font-family:Time New Roman !important;margin-bottom:20px !important;">Creadit Note</h2></center>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6 col-sm-6 col-xs-6">
				<table>
					...
					<tr>
						<td style="margin-top:100px !important;font-size:17px;font-weight:bold;"><?=strtoupper(lang('customer'))?></td>
					</tr>
					
					<tr>
						<td style="font-size:15px !important;"><?=lang('name')?>&nbsp;&nbsp;:&nbsp;&nbsp;<?= $customer->name ? $customer->name : $customer->company; ?></td>
					</tr>
					<tr>
			...
			<div class="col-lg-12 col-sm-12 col-xs-12">
				...
				<thead>
					<tr>
						...
						<th style="font-size:13px !important;"class="text-center"><?=lang('Quanity')?></th>
