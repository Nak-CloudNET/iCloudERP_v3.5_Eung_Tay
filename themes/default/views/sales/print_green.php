...
<div style="margin-top:20px;width:30%;position:absolute;text-align:center;">
	 <img src="'. base_url() . 'assets/uploads/logos/'.$logo.'" alt="company_logo"> 
</div>
<div style="">
	<p style="text-align:center;font-weight:bold;font-size:30px;margin-top: 0;">
		<span style="">'.$company.'</span>
	</p>
	<p style="text-align:center;font-weight:bold;font-size:20px;"><span style="font-family:Khmer OS Muol;">
		ផ្កត់ផ្គង់និងចែកចាយបន្លែគ្រប់ប្រភេទ
	</span></p>
	<p style="text-align:center;font-weight:bold;font-size:12px;">
		<span style="font-family:Khmer OS;">'.$address.'</span>
	</p>
</div>
